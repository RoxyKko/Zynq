...
//Date        : Thu Oct 13 13:25:36 2022
//Host        : NongJieYing running 64-bit major release  (build 9200)
//Command     : generate_target EMIO.bd
//Design      : EMIO
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "EMIO,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=EMIO,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "EMIO.hwdef" *) 
module EMIO
   (DDR_0_addr,
    DDR_0_ba,
    DDR_0_cas_n,
  ...
  EMIO_processing_system7_0_0 processing_system7_0
